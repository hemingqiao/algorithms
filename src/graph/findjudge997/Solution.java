package src.graph.findjudge997;
...
入度和出度的概念可以去查一下，这里就简单说一下
入度：以 a 为终点的边的数量 称为 a 的入度
出度：以 a 为起点的边的数量 称为 a 的出度
那么很容易在这道题中 a 的入度表示信任 a 的人的个数，a 的出度表示 a 信任的人的个数
所以根据题意有唯一的一个人，被其他 N-1 个人信任而他信任 0 个人即找到一个节点，该节点入度为 N-1 出度为 0；
 */
